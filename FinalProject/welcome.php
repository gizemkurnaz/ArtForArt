...
<div class="card-title top_border">
    <nav class="navbar top_border  justify-content-between">
        ...
        <form method="post" align ="center"  >
            <button class="btn btn-sm categories_style" type="submit" name="painting" > Painting</button>
            <button class="btn btn-sm categories_style" type="submit" name="printmaking"  > Printmaking</button>
            <button class="btn btn-sm categories_style"  type="submit" name="photography" > Photography</button>
            <button class="btn btn-sm categories_style"  type="submit" name="drawing"> Drawing</button>
            <button class="btn btn-sm categories_style"  type="submit" name="digital_art"> Digital Art</button>
        </form>
